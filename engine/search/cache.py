"""Search caching with LRU eviction."""
...
# Cache directory relative to project root: <project>/system/cache/search
SEARCH_CACHE_DIR = Path(__file__).resolve().parent.parent.parent / "system" / "cache" / "search"
