"""Minimal config shim for the ChatGPT browser scraper engine."""
...
# Sable repository root: engine/scraper_engines/chatgpt -> parents[3]
...
active_key = os.environ.get("GHOST_PLATFORM") or PLATFORMS_CONFIG.get("active_platform", "chatgpt")
